...
const S0b_Holdings_Two_JournalEntry = sequelize.define(
  'S0b_Holdings_Two_JournalEntry',
  {
    amount: {
...
export default S0b_Holdings_Two_JournalEntry;
